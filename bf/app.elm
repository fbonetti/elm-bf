...
instructionsTable =
  table [ tableStyle ]
    [ tbody []
        ...
        , tr []
            [ td [ cellStyle textCenter ] [ text "[" ]
            , td [ cellStyle [] ] [ text "if the current byte is zero, jump to the next matching bracket" ]
            ]
        , tr []
            [ td [ cellStyle textCenter ] [ text "]" ]
            , td [ cellStyle [] ] [ text "if the current byte is nonzero, rewind to the matching bracket" ]
            ]
        ]
    ]
