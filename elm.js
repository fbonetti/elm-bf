...
Elm.Interpreter = Elm.Interpreter || {};
Elm.Interpreter.make = function (_elm) {
   "use strict";
   _elm.Interpreter = _elm.Interpreter || {};
   if (_elm.Interpreter.values)
   return _elm.Interpreter.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var decrementByte = function (state) {
      return function () {
         var current = A2($Array.get,
         state.dataPointer,
         state.data);
   ...
   var incrementByte = function (state) {
      return function () {
         var current = A2($Array.get,
         state.dataPointer,
         state.data);
   ...
   var incrementDataPointer = function (state) {
      return _U.eq(state.dataPointer + 1,
...
Elm.Main.make = function (_elm) {
   ...
   $Interpreter = Elm.Interpreter.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   ...
   var codeMailbox = $Signal.mailbox("");
   var view = function (model) {
      ...
      _L.fromArray([A2($Html.textarea,
                   ...
                   ,A2($Html.div,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text(model.output)]))]));
   };
